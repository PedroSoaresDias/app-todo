...
export default function CriarTarefa() {
    ...
    return (
        <section className="flex flex-col items-center min-h-screen">
            <Link className="flex bg-blue-600 hover:bg-blue-700 transition-all duration-300 p-3 text-white font-semibold text-center rounded-md flex-col justify-center w-11/12 md:w-9/12 sm:w-3/5 mt-6" href={"/"}>Retornar a página principal</Link>
